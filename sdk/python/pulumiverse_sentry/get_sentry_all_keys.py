...
def get_sentry_all_keys_output(filter_status: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['project'] = project
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('sentry:index/getSentryAllKeys:getSentryAllKeys', __args__, opts=opts, typ=GetSentryAllKeysResult)
    return __ret__.apply(lambda __response__: GetSentryAllKeysResult(
