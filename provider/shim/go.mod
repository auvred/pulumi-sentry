...
require (
	...
	github.com/jianyuan/terraform-provider-sentry v0.14.3
)
...
require (
	...
	github.com/jianyuan/go-sentry/v2 v2.8.4 // indirect
	github.com/jianyuan/go-utils v0.0.0-20241210005310-ec4088c3adbd // indirect
