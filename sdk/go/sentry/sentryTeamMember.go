...
//			_, err := sentry.NewSentryOrganizationMember(ctx, "default", &sentry.SentryOrganizationMemberArgs{
...
//				return err
//			}
//			defaultSentryTeam, err := sentry.NewSentryTeam(ctx, "default", &sentry.SentryTeamArgs{
//				Organization: pulumi.String("my-organization"),
...
//				return err
//			}
//			_, err = sentry.NewSentryTeamMember(ctx, "default", &sentry.SentryTeamMemberArgs{
//				Organization: pulumi.String("my-organization"),
//				Team:         defaultSentryTeam.ID(),
//				MemberId:     _default.InternalId,
//			})
//			if err != nil {
//				return err
//			}
