...
def get_sentry_project(organization: Optional[str] = None,
    ...
    :param str slug: The project the resource belongs to.
    """
    __args__ = dict()
...
def get_sentry_project_output(organization: Optional[pulumi.Input[str]] = None,
    ...
    __args__['slug'] = slug
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('sentry:index/getSentryProject:getSentryProject', __args__, opts=opts, typ=GetSentryProjectResult)
    return __ret__.apply(lambda __response__: GetSentryProjectResult(
