...
def get_sentry_all_projects_output(organization: Optional[pulumi.Input[str]] = None,
    ...
    __args__['organization'] = organization
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('sentry:index/getSentryAllProjects:getSentryAllProjects', __args__, opts=opts, typ=GetSentryAllProjectsResult)
    return __ret__.apply(lambda __response__: GetSentryAllProjectsResult(
        id=pulumi.get(__response__, 'id'),
        organization=pulumi.get(__response__, 'organization'),
        project_slugs=pulumi.get(__response__, 'project_slugs'),
