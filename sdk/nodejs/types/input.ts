...
export interface SentryIssueAlertActionsV2 {
     ...
     */
    azureDevopsCreateTicket?: pulumi.Input<inputs.SentryIssueAlertActionsV2AzureDevopsCreateTicket>;
    /**
     ...
     */
    discordNotifyService?: pulumi.Input<inputs.SentryIssueAlertActionsV2DiscordNotifyService>;
    /**
     * Create a GitHub issue in `integration`.
     */
    githubCreateTicket?: pulumi.Input<inputs.SentryIssueAlertActionsV2GithubCreateTicket>;
    /**
     * Create a GitHub Enterprise issue in `integration`.
     */
    githubEnterpriseCreateTicket?: pulumi.Input<inputs.SentryIssueAlertActionsV2GithubEnterpriseCreateTicket>;
    /**
     * Create a Jira issue in `integration`.
     */
    jiraCreateTicket?: pulumi.Input<inputs.SentryIssueAlertActionsV2JiraCreateTicket>;
    /**
     * Create a Jira Server issue in `integration`.
     */
    jiraServerCreateTicket?: pulumi.Input<inputs.SentryIssueAlertActionsV2JiraServerCreateTicket>;
    /**
     * Send a notification to the `team` Team to `channel`.
     */
    msteamsNotifyService?: pulumi.Input<inputs.SentryIssueAlertActionsV2MsteamsNotifyService>;
    /**
     * Send a notification to `targetType` and if none can be found then send a notification to `fallthroughType`.
     */
    notifyEmail?: pulumi.Input<inputs.SentryIssueAlertActionsV2NotifyEmail>;
    /**
     * Send a notification to all legacy integrations.
     */
    notifyEvent?: pulumi.Input<inputs.SentryIssueAlertActionsV2NotifyEvent>;
    /**
     * Send a notification to a Sentry app.
     */
    notifyEventSentryApp?: pulumi.Input<inputs.SentryIssueAlertActionsV2NotifyEventSentryApp>;
    /**
     * Send a notification via an integration.
     */
    notifyEventService?: pulumi.Input<inputs.SentryIssueAlertActionsV2NotifyEventService>;
    /**
     * Send a notification to Opsgenie account `account` and team `team` with `priority` priority.
     */
    opsgenieNotifyTeam?: pulumi.Input<inputs.SentryIssueAlertActionsV2OpsgenieNotifyTeam>;
    /**
     * Send a notification to PagerDuty account `account` and service `service` with `severity` severity.
     */
    pagerdutyNotifyService?: pulumi.Input<inputs.SentryIssueAlertActionsV2PagerdutyNotifyService>;
    /**
     ...
     */
    slackNotifyService?: pulumi.Input<inputs.SentryIssueAlertActionsV2SlackNotifyService>;
}
...
export interface SentryIssueAlertConditionsV2 {
     ...
     */
    eventFrequency?: pulumi.Input<inputs.SentryIssueAlertConditionsV2EventFrequency>;
    /**
     ...
     */
    eventFrequencyPercent?: pulumi.Input<inputs.SentryIssueAlertConditionsV2EventFrequencyPercent>;
    /**
     ...
     */
    eventUniqueUserFrequency?: pulumi.Input<inputs.SentryIssueAlertConditionsV2EventUniqueUserFrequency>;
    /**
     * Sentry marks an existing issue as high priority.
     */
    existingHighPriorityIssue?: pulumi.Input<inputs.SentryIssueAlertConditionsV2ExistingHighPriorityIssue>;
    /**
     * A new issue is created.
     */
    firstSeenEvent?: pulumi.Input<inputs.SentryIssueAlertConditionsV2FirstSeenEvent>;
    /**
     * Sentry marks a new issue as high priority.
     */
    newHighPriorityIssue?: pulumi.Input<inputs.SentryIssueAlertConditionsV2NewHighPriorityIssue>;
    /**
     * The issue changes state from ignored to unresolved.
     */
    reappearedEvent?: pulumi.Input<inputs.SentryIssueAlertConditionsV2ReappearedEvent>;
    /**
     * The issue changes state from resolved to unresolved.
     */
    regressionEvent?: pulumi.Input<inputs.SentryIssueAlertConditionsV2RegressionEvent>;
}
...
export interface SentryIssueAlertFiltersV2 {
     ...
     */
    ageComparison?: pulumi.Input<inputs.SentryIssueAlertFiltersV2AgeComparison>;
    /**
     * The issue is assigned to no one, team, or member.
     */
    assignedTo?: pulumi.Input<inputs.SentryIssueAlertFiltersV2AssignedTo>;
    /**
     * The event's `attribute` value `match` `value`.
     */
    eventAttribute?: pulumi.Input<inputs.SentryIssueAlertFiltersV2EventAttribute>;
    /**
     * The issue's category is equal to `value`.
     */
    issueCategory?: pulumi.Input<inputs.SentryIssueAlertFiltersV2IssueCategory>;
    /**
     * The issue has happened at least `value` times (Note: this is approximate).
     */
    issueOccurrences?: pulumi.Input<inputs.SentryIssueAlertFiltersV2IssueOccurrences>;
    /**
     ...
     */
    latestAdoptedRelease?: pulumi.Input<inputs.SentryIssueAlertFiltersV2LatestAdoptedRelease>;
    /**
     * The event is from the latest release.
     */
    latestRelease?: pulumi.Input<inputs.SentryIssueAlertFiltersV2LatestRelease>;
    /**
     * The event's level is `match` `level`.
     */
    level?: pulumi.Input<inputs.SentryIssueAlertFiltersV2Level>;
    /**
     * The event's tags match `key` `match` `value`.
     */
    taggedEvent?: pulumi.Input<inputs.SentryIssueAlertFiltersV2TaggedEvent>;
}
