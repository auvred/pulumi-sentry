...
class SentryTeamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        default = sentry.SentryOrganizationMember("default",
            organization="my-organization",
            email="test@example.com",
            role="member")
        default_sentry_team = sentry.SentryTeam("default",
            organization="my-organization",
            name="my-team",
            slug="my-team")
        default_sentry_team_member = sentry.SentryTeamMember("default",
            organization="my-organization",
            team=default_sentry_team.id,
            member_id=default.internal_id)
        ```
